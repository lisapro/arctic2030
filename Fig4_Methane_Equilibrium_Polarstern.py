...
def plot_Figure_4(txt = False,save = False):
    ...
    if save == True: 
        plt.savefig('Fig/Figure4_methane_polarstern.pdf',
                    format =  'pdf',
                    transparent = False)    
    else:   
        plt.show()
